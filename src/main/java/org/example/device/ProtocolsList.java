...
public enum ProtocolsList {
    ...
    ARD_MIPEX_EMU("ARD_MIPEX_EMU"),
    BKM4_DEVICE("BKM4_DEVICE"),
    BOTO800_DEVICE("BOTO800_DEVICE"),
    BOTO1000_DEVICE("BOTO1000_DEVICE"),
    ARD_CUR_LOOP_METER("ARD_CUR_LOOP_METER"),
    ARD_TERM("ARD_TERM"),
    ...
    MSK_MGU_UsbAdc10("MSK_MGU_UsbAdc10"),
