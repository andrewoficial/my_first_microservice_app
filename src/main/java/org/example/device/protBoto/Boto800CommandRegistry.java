...
public class Boto800CommandRegistry extends DeviceCommandRegistry {
    ...
    public static final int REG_TEMP = 10;
    public static final int REG_SET_TEMP = 60;
    public static final int REG_SET_MOD = 63;
    public static final int TEMP_SCALE = 10;
    ...
    private SingleCommand createReadTempCmd() {
        ...
        return new SingleCommand(
                "readTemp",
                "readTemp - чтение текущей температуры (регистр 10, ×10)",
                "readTemp",
                body,
                args -> body,
    ...
    private SingleCommand createWriteSetTempCmd() {
        ...
        SingleCommand cmd = new SingleCommand(
                "writeSetTemp",
                "writeSetTemp <значение> - установка температуры (регистр 60, ×10, °C)",
                "writeSetTemp",
                empty,
                args -> {
    ...
    private SingleCommand createWriteModCmd() {
        ...
        SingleCommand cmd = new SingleCommand(
                "writeMod",
                "writeMod <0|1> - включение/выключение (регистр 63, 1=вкл, 0=выкл)",
                "writeMod",
                empty,
                args -> {
                    Object v = args.get("value");
